...
import { Text, TextInputs, Buttons, ScrollViews, Wrapper, Spacer, Headers, StatusBars, Images, CheckBoxes, } from '../../../components';
...
export default function Index(props) {
  ...
  const { toggleCheckbox, isChecked, email,setEmail ,password, setPassword, togglePasswordVisibility, showPassword } = useHooks()
  return (
      ...
      <ScrollViews.KeyboardAvoiding>
        <Wrapper>
          ...
          <Wrapper  flexDirectionRow justifyContentCenter alignItemsCenter style={{marginTop: width(20), }}>
            <Image source={appImages.book} style={{ height: height(12), width: width(20), }} />
          ...
          <Wrapper marginVerticalSmall paddingHorizontalSmall>
            <TextInputs.Colored title={'Email Address'} value={email} onChangeText={(text) => setEmail(text)} keyboardType={'email-address'} inputContainerStyle={{ borderColor: colors.inputTextBorder }} customIconLeft={appIcons.mail} iconSizeLeft={sizes.icons.mediumTiny} inputStyle={{fontSize: fontSizes.regular, fontFamily: appFonts.appTextRegular, color:colors.appTextColor1}}
            ...
            <TextInputs.Colored title={'Password'} value={password} onChangeText={(text) => setPassword(text)} keyboardType={'default'} secureTextEntry={!showPassword} onPressIconRight={togglePasswordVisibility} inputContainerStyle={{ borderColor: colors.inputTextBorder }} containerStyle={{ marginTop: height(2) }} customIconLeft={appIcons.lock} iconSizeLeft={sizes.icons.mediumTiny} inputStyle={{fontSize: fontSizes.regular, fontFamily: appFonts.appTextRegular, color:colors.appTextColor1}}
            ...
            <Wrapper flexDirectionRow alignItemsCenter marginHorizontalBase justifyContentSpaceBetween marginVerticalSmall>
              ...
              <Buttons.ColoredSmall text={'Forgot Password?'} buttonStyle={{ backgroundColor: colors.transparent, marginRight: responsiveWidth(-5) }} textStyle={{ color: colors.appTextColor8, fontSize: fontSizes.tiny, fontFamily: appFonts.appTextRegular }} />
            </Wrapper>
          </Wrapper>
          <Wrapper marginVerticalMedium style={{ marginHorizontal: width(20)}} >
            <Buttons.Colored buttonColor={colors.buttonColor1} buttonStyle={{ height: height(8) }} text={'Login'} customIconRight={appIcons.logIn} textStyle={{ fontFamily: appFonts.appTextBold, fontSize: fontSizes.regular }} />
          </Wrapper>
          <Wrapper isCenter>
          ...
          <Wrapper marginVerticalLarge >
            ...
            <Wrapper marginVerticalSmall style={{ marginHorizontal: width(20)}} >
              <Buttons.Colored buttonColor={colors.buttonColor2} buttonStyle={{ height: height(8) }} text={'Create an Account'} textStyle={{ fontFamily: appFonts.appTextBold, fontSize: fontSizes.regular, color:colors.appTextColor1}} />
            </Wrapper>
          </Wrapper>
        </Wrapper>
